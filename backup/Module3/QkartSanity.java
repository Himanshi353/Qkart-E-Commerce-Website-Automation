...
public class QkartSanity {
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("End TestCase", "Test Case 8: Verify Multitab Scenario ", "PASS" );
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        String currTabUrl=driver.getCurrentUrl();
        if(!currTabUrl.equals("https://crio-qkart-frontend-qa.vercel.app/")){
            logStatus("Step Failure", "Current Tab Verification Failed", "FAIL");
            return false;
        }
        ...
        if(!privacyPolicyContent.isDisplayed()){
          logStatus("Step Failure", "Privacy Policy content Verification Failed", "FAIL");
        ...
        currTabUrl=driver.getCurrentUrl();
        if(!currTabUrl.equals("https://crio-qkart-frontend-qa.vercel.app/")){
            takeScreenshot(driver, "Failed", "TestCase09");
            logStatus("Step Failure", "Current Tab Verification Failed", "FAIL");
            return false;
        ...
        WebElement TermsofServiceContent=driver.findElement(By.xpath("//h2[normalize-space()='Terms of Service']"));
        if(!TermsofServiceContent.isDisplayed()){
          takeScreenshot(driver, "Failed", "TestCase09");
          logStatus("Step Failure", "Terms of Service content Verification Failed", "FAIL");
        }
        driver.close();
        driver.switchTo().window(windows[1]);
        driver.close();
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        WebElement contactus=driver.findElement(By.xpath("//p[normalize-space()='Contact us']"));
        contactus.click();
        WebDriverWait wait=new WebDriverWait(driver, 3);
        ...
        logStatus("TestCase 10", "Test Case PASS. Validated the “Contact us” link works fine.", "PASS");
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Start TestCase", "Test Case 11: verify ads displayed on the final page ", "DONE");
        ...
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            logStatus("TestCase 11", "Test Case Failure. verify ads are displayed on the final page ", "FAIL");
        }
        ...
        if (!status) {
            ...
            logStatus("End TestCase", "Test Case 11:verify ads are displayed on the final page  : ", status ? "PASS" : "FAIL");
        }
        ...
        driver.navigate().back();
        driver.switchTo().parentFrame();
        logStatus("TestCase 11", "Test Case PASS. validated the ads are displayed on the final page and URL flow works fine", "PASS");
